...
sablono.util.ToString = (function (){var obj16512 = {};return obj16512;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__7857__auto__ = x;if(and__7857__auto__)
...
{var x__8496__auto__ = (((x == null))?null:x);return (function (){var or__7869__auto__ = (sablono.util.to_str[goog.typeOf(x__8496__auto__)]);if(or__7869__auto__)
{return or__7869__auto__;
} else
{var or__7869__auto____$1 = (sablono.util.to_str["_"]);if(or__7869__auto____$1)
...
sablono.util.ToURI = (function (){var obj16514 = {};return obj16514;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__7857__auto__ = x;if(and__7857__auto__)
...
{var x__8496__auto__ = (((x == null))?null:x);return (function (){var or__7869__auto__ = (sablono.util.to_uri[goog.typeOf(x__8496__auto__)]);if(or__7869__auto__)
{return or__7869__auto__;
} else
{var or__7869__auto____$1 = (sablono.util.to_uri["_"]);if(or__7869__auto____$1)
{return or__7869__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__16515){
var xs = cljs.core.seq(arglist__16515);
...
{var vec__16517 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__16517,0,null);var words = cljs.core.nthnext.call(null,vec__16517,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__16518_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__16518_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16518_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__16518_SHARP_))
{return p1__16518_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__16519){
var maps = cljs.core.seq(arglist__16519);
...
*/
sablono.util.normalize_element = (function normalize_element(p__16524){var vec__16527 = p__16524;var tag = cljs.core.nth.call(null,vec__16527,0,null);var content = cljs.core.nthnext.call(null,vec__16527,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__16528 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__16528,0,null);var id = cljs.core.nth.call(null,vec__16528,1,null);var class$ = cljs.core.nth.call(null,vec__16528,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__7869__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__7869__auto__))
{return or__7869__auto__;
} else
