...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8436__auto__,writer__8437__auto__,opt__8438__auto__){return cljs.core._write.call(null,writer__8437__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_19192 = 0;while(true){
if((i_19192 < arr.length))
{(arr[i_19192] = null);
{
var G__19193 = (i_19192 + 1);
i_19192 = G__19193;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8436__auto__,writer__8437__auto__,opt__8438__auto__){return cljs.core._write.call(null,writer__8437__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_19199 = (self__.level + 1);while(true){
if((i_19199 <= (new_level + 1)))
{(update[i_19199] = self__.header);
{
var G__19200 = (i_19199 + 1);
i_19199 = G__19200;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19201 = 0;while(true){
if((i_19201 <= self__.level))
{var links_19202 = (update[i_19201]).forward;if(((links_19202[i_19201]) === x__$1))
{(links_19202[i_19201] = (x__$1.forward[i_19201]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7869__auto__ = (cljs.core.truth_((function (){var and__7857__auto__ = me;if(cljs.core.truth_(and__7857__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7857__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7869__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7869__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7869__auto__,timeout__$1,me))
,msecs);
