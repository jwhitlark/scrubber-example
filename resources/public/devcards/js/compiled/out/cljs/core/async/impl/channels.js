...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19289 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19289 = (function (val,box,meta19290){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19289.cljs$lang$type = true;
cljs.core.async.impl.channels.t19289.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19289";
cljs.core.async.impl.channels.t19289.cljs$lang$ctorPrWriter = (function (this__8436__auto__,writer__8437__auto__,opt__8438__auto__){return cljs.core._write.call(null,writer__8437__auto__,"cljs.core.async.impl.channels/t19289");
});
cljs.core.async.impl.channels.t19289.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19289.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19291){var self__ = this;
var _19291__$1 = this;return self__.meta19290;
});
cljs.core.async.impl.channels.t19289.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19291,meta19290__$1){var self__ = this;
var _19291__$1 = this;return (new cljs.core.async.impl.channels.t19289(self__.val,self__.box,meta19290__$1));
});
cljs.core.async.impl.channels.__GT_t19289 = (function __GT_t19289(val__$1,box__$1,meta19290){return (new cljs.core.async.impl.channels.t19289(val__$1,box__$1,meta19290));
});
}
return (new cljs.core.async.impl.channels.t19289(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8439__auto__,writer__8440__auto__,opts__8441__auto__){return cljs.core._write.call(null,writer__8440__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8436__auto__,writer__8437__auto__,opt__8438__auto__){return cljs.core._write.call(null,writer__8437__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_19292 = self__.takes.pop();if((taker_19292 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19292))
{var take_cb_19293 = cljs.core.async.impl.protocols.commit.call(null,taker_19292);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19293,taker_19292,this$__$1){
return (function (){return take_cb_19293.call(null,null);
});})(take_cb_19293,taker_19292,this$__$1))
);
} else
{}
{
