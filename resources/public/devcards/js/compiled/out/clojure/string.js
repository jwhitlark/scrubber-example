...
{{
var G__15786 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15786;
continue;
}
} else
...
{var pred__15790 = cljs.core._EQ_;var expr__15791 = limit;if(cljs.core.truth_(pred__15790.call(null,1,expr__15791)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15790.call(null,2,expr__15791)))
...
var G__15793 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15794 = (limit__$1 - 1);
var G__15795 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15793;
limit__$1 = G__15794;
parts = G__15795;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___15797 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___15797))
{var replacement_15798 = temp__4124__auto___15797;buffer.append([cljs.core.str(replacement_15798)].join(''));
} else
{buffer.append(ch);
}
{
var G__15799 = (index + 1);
index = G__15799;
continue;
}
}
