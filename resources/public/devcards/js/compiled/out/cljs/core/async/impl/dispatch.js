...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19283 = 0;while(true){
var m_19284 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19284 == null))
{} else
{m_19284.call(null);
if((count_19283 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19285 = (count_19283 + 1);
count_19283 = G__19285;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7857__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7857__auto__)
